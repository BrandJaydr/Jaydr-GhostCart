-- ─────────────────────────────────────────────────────────────────────────────
-- Jaydr GhostCart — Migration 0009: Stock/Price Refresh System
-- Stage: Stage 4 — Reliability and Controlled Automation
-- Reference: Stage 4 Plan — Task 1: Stock/Price Refresh System
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─── Functions for Price Change Detection ───────────────────────────────────────
...
CREATE OR REPLACE FUNCTION products.log_stock_change(
  p_product_id UUID,
  p_old_stock INTEGER,
  p_new_stock INTEGER,
  p_source TEXT,
